...
function Input({
  ...
  return (
    (<input
      ...
      data-slot="input"
      className={cn(
        "file:text-stone-950 placeholder:text-stone-500 selection:bg-stone-900 selection:text-stone-50 dark:bg-stone-200/30 border-stone-200 flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm dark:file:text-stone-50 dark:placeholder:text-stone-400 dark:selection:bg-stone-50 dark:selection:text-stone-900 dark:dark:bg-stone-800/30 dark:border-stone-800",
